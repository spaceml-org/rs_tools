...
from georeader.griddata import (
    footprint as swath_footprint,
    read_to_crs,
)
...
from rs_tools._src.geoprocessing.modis.ops import load_modis_bands_raw, load_modis_cloud_mask_raw
